# Django settings for staticpages project.
...
DATABASES = {
    'default': {
        ...
        'NAME': '/home/juanmiguel/Aptana Studio 3 Workspace/django_projects/staticpages/datab.db',                      # Or path to database file if using sqlite3.
...
SECRET_KEY = 'kjy^be5a^&q-&rl$25ufho^5%&cn&up&b(ls1+-l-$t1ehydni'
